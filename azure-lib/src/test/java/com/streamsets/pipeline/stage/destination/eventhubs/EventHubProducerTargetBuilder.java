...
class EventHubProducerTargetBuilder {
  private EventHubConfigBean commonConf;
  private EventHubProducerConfigBean producerConf;

  EventHubProducerTargetBuilder() {
    commonConf = new EventHubConfigBean();
    producerConf = new EventHubProducerConfigBean();
